...
|-----|---------|--------|----------|
| [EAGLE-3] | UC-1 Create an acquisition package | To Do | Unassigned |
...
| Key | Summary | Status | Assignee |
|-----|---------|--------|----------|
| [EAGLE-1] | Create User Authentication and Role Selection | To Do | Unassigned |
| [EAGLE-2] | Display COR Acquisition Options | To Do | Unassigned |
| [EAGLE-4] | Initiate a New Acquisition Package | To Do | Unassigned |
| [EAGLE-5] | Capture Core Acquisition Data | To Do | Unassigned |
| [EAGLE-6] | Handle Incomplete or Unknown Acquisition Data | To Do | Unassigned |
| [EAGLE-7] | Chat with Contracting Officer via Teams | To Do | Unassigned |
| [EAGLE-8] | Generate Acquisition Documentation | To Do | Unassigned |
| [EAGLE-9] | Validate Acquisition Package for Compliance | To Do | Unassigned |
| [EAGLE-10] | Download Acquisition Package | To Do | Unassigned |
| [EAGLE-11] | Store Acquisition Package in SharePoint | To Do | Unassigned |
