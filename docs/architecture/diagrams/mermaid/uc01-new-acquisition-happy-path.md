# UC-01: New Acquisition Intake (Happy Path)

**Use Case:** Simple acquisition ($85K lab equipment) with complete user knowledge
**Key Pattern:** Linear flow: Intake → Determination → Document Generation
**Actors:** COR/Program Staff, Supervisor Agent, OA Intake Skill, Document Generator Skill
