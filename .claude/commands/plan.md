...
USER_PROMPT: $1
PLAN_OUTPUT_DIRECTORY: `.claude/specs/`
...
- Example: `python -c "import py_compile; py_compile.compile('test_eagle_sdk_eval.py', doraise=True)"` - Syntax check
- Example: `python test_eagle_sdk_eval.py --model haiku --tests 16,17` - Run specific tests
